...
echo "Validating docs/governance/archive/policy/guards.axion"
python3 "$REPO_ROOT/tools/axion_policy_validator.py" "$REPO_ROOT/docs/governance/archive/policy/guards.axion"
