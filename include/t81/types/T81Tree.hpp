...
public:
  ...
  T81Tree(const value_type& v, children_array children = {})
      : value_(v), children_(std::move(children)) {}

  T81Tree(value_type&& v, children_array children = {})
      : value_(std::move(v)), children_(std::move(children)) {}
  ...
  static ptr leaf(const value_type& v) { return std::make_shared<node_type>(v, children_array{}); }
  ...
  static ptr node(const value_type& v, std::optional<ptr> left, std::optional<ptr> middle,
                  std::optional<ptr> right) {
    children_array children{left ? *left : ptr{}, middle ? *middle : ptr{}, right ? *right : ptr{}};
    return std::make_shared<node_type>(v, std::move(children));
  }

  static ptr node(value_type&& v, std::optional<ptr> left, std::optional<ptr> middle,
                  std::optional<ptr> right) {
    children_array children{left ? *left : ptr{}, middle ? *middle : ptr{}, right ? *right : ptr{}};
    return std::make_shared<node_type>(std::move(v), std::move(children));
  }
  ...
  [[nodiscard]] const children_array& children() const noexcept { return children_; }
