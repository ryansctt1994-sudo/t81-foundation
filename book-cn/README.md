...
7. **[验证与审计](./07_验证与审计.md)**
   ...
   * [7.1 形式化验证方法论](./07_验证与审计.md#71-形式化验证方法论)
   * [7.2 形式化审计矩阵](./07_验证与审计.md#72-形式化审计矩阵)
   * [7.3 基于属性的测试](./07_验证与审计.md#73-基于属性的测试)
...
9. **[认知层与分布式计算](./09_认知层与分布式计算.md)**
   ...
   * [9.3 基于追踪的 JIT 编译](./09_认知层与分布式计算.md#93-基于追踪的-jit-编译)
   * [9.4 无限形式 (第 5 层)](./09_认知层与分布式计算.md#94-无限形式-第-5-层)

10. **[附录](./10_附录.md)**

* [10.1 尚未实现的功能](./10_附录.md#101-尚未实现的功能)
* [10.2 术语表](./10_附录.md#102-术语表)
...
11. **[TISC 和 T81VM 的形式化语义](./11_形式化语义.md)**

* [11.1 操作语义](./11_形式化语义.md#111-操作语义)
* [11.2 代数转换函数](./11_形式化语义.md#112-代数转换函数)
* [11.3 规范化重写系统](./11_形式化语义.md#113-规范化重写系统)
* [11.4 确定性证明草图](./11_形式化语义.md#114-确定性证明草图)
* [11.5 解释器与 Trace-JIT 等效性](./11_形式化语义.md#115-解释器与-trace-jit-等效性)

12. **[对抗建模与确定性攻击](./12_对抗建模.md)**

* [12.1 威胁模型](./12_对抗建模.md#121-威胁模型)
* [12.2 编译器级攻击](./12_对抗建模.md#122-编译器级攻击)
* [12.3 VM 和 GC 攻击向量](./12_对抗建模.md#123-vm-和-gc-攻击向量)
* [12.4 CanonFS 和哈希攻击](./12_对抗建模.md#124-canonfs-和哈希攻击)
* [12.5 分布式层时间旅行攻击](./12_对抗建模.md#125-分布式层时间旅行攻击)
* [12.6 确定性破坏事后分析模板](./12_对抗建模.md#126-确定性破坏事后分析模板)
...
* [13.1 无尘室协议](./13_持续性与韧性.md#131-无尘室协议)
* [13.2 单点故障](./13_持续性与韧性.md#132-单点故障)
* [13.3 持续性清单](./13_持续性与韧性.md#133-持续性清单)
* [13.4 不可变的形式不变量](./13_持续性与韧性.md#134-不可变的形式不变量)

14. **[研究前沿](./14_研究前沿.md)**

* [14.1 三进制硬件加速](./14_研究前沿.md#141-三进制硬件加速)
* [14.2 形式化验证路径](./14_研究前沿.md#142-形式化验证路径)
* [14.3 CanonFS 作为 Merkle 基底](./14_研究前沿.md#143-canonfs-作为-merkle-基底)
* [14.4 大规模确定性 AI 推理](./14_研究前沿.md#144-大规模确定性-ai-推理)
