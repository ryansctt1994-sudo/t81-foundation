...
int main() {
  ...
  run_and_check("fn main() -> T81Int { "
                ...
                [](const vm::State& state) {
                  ...
                  [[maybe_unused]] int float_handle = static_cast<int>(state.contexts[0].registers[1]);
                  ...
                  [[maybe_unused]] int frac_handle = static_cast<int>(state.contexts[0].registers[2]);
                  ...
                  [[maybe_unused]] int sym_handle = static_cast<int>(state.contexts[0].registers[3]);
                  assert(sym_handle == 1);
  ...
  run_and_check("fn main() -> T81Float { return 1.20t81; }", [](const vm::State& state) {
    const double expected = expected_base81_float();
    [[maybe_unused]] int handle = static_cast<int>(state.contexts[0].registers[1]);
    assert(handle == 1);
  ...
  run_and_check("fn main() -> T81Fraction { return 22/7t81; }", [](const vm::State& state) {
    [[maybe_unused]] int handle = static_cast<int>(state.contexts[0].registers[1]);
    assert(handle == 1);
  ...
  run_and_check("fn main() -> Symbol { return :omega; }", [](const vm::State& state) {
    [[maybe_unused]] int handle = static_cast<int>(state.contexts[0].registers[1]);
    assert(handle == 1);
