...
void test_if_statement_true() {
    ...
    T81_TEST_CHECK(vm->state().registers[1] == 1 && "VM register R1 has incorrect value for true branch");
...
void test_if_statement_false() {
    ...
    T81_TEST_CHECK(vm->state().registers[1] == 0 && "VM register R1 has incorrect value for false branch");
...
void test_if_else_statement() {
    ...
    T81_TEST_CHECK(vm->state().registers[1] == 123 && "VM register R1 has incorrect value for else branch");
