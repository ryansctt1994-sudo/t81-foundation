...
void test_addition() {
    ...
    T81_TEST_CHECK(vm->state().registers[1] == 42 && "VM register R1 has incorrect value after addition");
...
void test_subtraction() {
    ...
    T81_TEST_CHECK(vm->state().registers[1] == 42 && "VM register R1 has incorrect value after subtraction");
...
void test_multiplication() {
    ...
    T81_TEST_CHECK(vm->state().registers[1] == 42 && "VM register R1 has incorrect value after multiplication");
...
void test_division() {
    ...
    T81_TEST_CHECK(vm->state().registers[1] == 42 && "VM register R1 has incorrect value after division");
