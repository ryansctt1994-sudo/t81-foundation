...
void test_conv2d_layer() {
    ...
    // Set weights
    layer.weight(0, 0, 0, 0) = TF(1.0); layer.weight(0, 0, 0, 1) = TF(0.0);
    layer.weight(0, 0, 1, 0) = TF(0.0); layer.weight(0, 0, 1, 1) = TF(1.0);

    layer.bias(0) = TF(0.5);

    T81Tensor<TF, 4, 1, 1, 3, 3> input;
    // Fill input
    input(0,0,0,0)=TF(1); input(0,0,0,1)=TF(2); input(0,0,0,2)=TF(3);
    input(0,0,1,0)=TF(4); input(0,0,1,1)=TF(5); input(0,0,1,2)=TF(6);
    input(0,0,2,0)=TF(7); input(0,0,2,1)=TF(8); input(0,0,2,2)=TF(9);
