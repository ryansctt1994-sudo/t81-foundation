...
int main() {
    ...
    // Construction
    [[maybe_unused]] T81Set<T81Symbol> empty;
    assert(empty.empty());
    assert(empty.size() == 0);

    [[maybe_unused]] T81Symbol sym1= T81Symbol::intern("sym1");
    [[maybe_unused]] T81Symbol sym2= T81Symbol::intern("sym2");
    [[maybe_unused]] T81Symbol sym3= T81Symbol::intern("sym3");

    // Insert (functional style - returns new set)
    [[maybe_unused]] T81Set<T81Symbol> set1= empty.insert(sym1);
    assert(set1.size() == 1);
    assert(set1.contains(sym1));

    [[maybe_unused]] T81Set<T81Symbol> set2= set1.insert(sym2);
    assert(set2.size() == 2);
    ...
    // Erase
    [[maybe_unused]] T81Set<T81Symbol> set4= set3.erase(sym2);
    assert(set4.size() == 2);
    ...
    [[maybe_unused]] T81Set<T81Symbol> union_set= set5 | set6;
    ...
    [[maybe_unused]] T81Set<T81Symbol> inter= set7 & set8;
    assert(inter.size() == 1);
