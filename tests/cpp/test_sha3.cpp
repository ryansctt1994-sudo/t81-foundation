...
static void run_test(const std::string& input, const std::string& expected_hex, const std::string& label) {
...
int main() {
    ...
    std::string long_input = "The quick brown fox jumps over the lazy dog"
                             ...
                             "The quick brown fox jumps over the lazy dog";
    run_test(long_input,
             "3cda341b539bd2e963e0221fc022b9411ee15dbb2fb64a96a1a75d233c1f34566ddf4a8879f490ea6f59b538155fa38c803f8e69d9ef4fd1ecd9e52744690aa3",
