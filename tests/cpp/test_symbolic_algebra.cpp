    ...
    if (auto* b = std::get_if<BinaryOp>(&df_simp->node)) {
        ...
        if (l) {
            ...
            if (!r) {
                ...
                if (std::holds_alternative<Variable>(b->rhs->node)) std::cout << "rhs is Variable\n";
                else if (std::holds_alternative<UnaryOp>(b->rhs->node)) std::cout << "rhs is UnaryOp\n";
                else if (std::holds_alternative<BinaryOp>(b->rhs->node)) std::cout << "rhs is BinaryOp\n";
            }
        ...
        if (std::holds_alternative<Constant>(df_simp->node)) std::cout << "Got Constant\n";
        else if (std::holds_alternative<Variable>(df_simp->node)) std::cout << "Got Variable\n";
        else if (std::holds_alternative<UnaryOp>(df_simp->node)) std::cout << "Got UnaryOp\n";
        else std::cout << "Got Unknown\n";
