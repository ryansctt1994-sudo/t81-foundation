...
class StreamCapture {
 public:
  StreamCapture(std::istream& in_target, std::streambuf* in_buf,
                std::ostream& out_target, std::streambuf* out_buf)
      : in_stream_(in_target), old_in_buf_(in_stream_.rdbuf(in_buf)),
        out_stream_(out_target), old_out_buf_(out_stream_.rdbuf(out_buf)) {}
