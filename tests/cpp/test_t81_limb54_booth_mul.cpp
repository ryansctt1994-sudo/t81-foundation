...
int main() {
    ...
    for (int t = 0; t < kTrials; ++t) {
        [[maybe_unused]] auto a= random_limb(rng);
        [[maybe_unused]] auto b= random_limb(rng);
        [[maybe_unused]] auto expected= T81Limb54::reference_mul(a, b);
