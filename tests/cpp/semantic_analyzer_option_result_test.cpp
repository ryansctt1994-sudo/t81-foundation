...
int main() {
  ...
  expect_semantic_failure(ok_without_context, "ok_without_context",
                          "requires a contextual Result[T, E] type");
  ...
  expect_semantic_failure(err_without_context, "err_without_context",
                          "requires a contextual Result[T, E] type");
