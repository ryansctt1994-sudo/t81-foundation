...
void test_conversions() {
    ...
    // Round trip checks
    check(F::from_double(d_inf).is_inf() && !F::from_double(d_inf).is_negative(), "double(+inf) -> T81Float should be +inf");
    check(F::from_double(d_neg_inf).is_inf() && F::from_double(d_neg_inf).is_negative(), "double(-inf) -> T81Float should be -inf");
