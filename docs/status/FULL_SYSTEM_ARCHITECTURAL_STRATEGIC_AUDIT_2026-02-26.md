...
- VM tensor trap conformance now includes explicit shape/compatibility fault expectations for `TSoftmax`, `TTranspose`, `TRoPE`, and `TRMSNorm` (`t81_vm_tensor_shape_faults_test`).
