...
| **T81Lang** | `spec/t81lang-spec.md` (Draft) | Experimental | Low | High | @t81dev | 2026-05-15 | Drift decomposition tracked in `docs/status/T81LANG_DRIFT_DECOMPOSITION_2026-03.md`; executable closure queue tracked in `docs/status/T81LANG_IMPLEMENTATION_TASK_QUEUE_2026-03.md`. |
| **Axion Kernel** | `spec/axion-kernel.md` (Draft) | Partial | Medium | Medium | @t81dev | 2026-04-30 | Partial-coverage alignment tracked in `docs/status/AXION_PARTIAL_COVERAGE_ALIGNMENT_2026-03.md` with bounded milestones (M1-M4) and dated status targets. |
