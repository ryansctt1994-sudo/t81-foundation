...
- Keep non-DCP boundaries unchanged.
 - Progress: shared native tensor decode path (`WeightsTensorHandle` promotion + `TLoadHash` decode) extracted to `tensor_helpers`; CanonFS tensor-object parsing moved out of `vm.cpp`.
