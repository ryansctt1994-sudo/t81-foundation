...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| A1-CODE-01 | Publish parser coverage matrix by section/production | `spec/t81lang-spec.md` section 1 + Appendix A | `lang/frontend/parser.cpp`, `lang/frontend/lexer.cpp` | `tests/cpp/frontend_parser_test.cpp`, `tests/cpp/test_parser_regression_audit.cpp` | 2026-03-03 | Planned |
...
| A1-CODE-03 | Codify deterministic compilation-profile invariants in status/spec trace docs (no runtime changes) | `spec/t81lang-spec.md` section 5 | `docs/status/VERIFIED_SURFACE_AUDIT.md`, related spec references | `tests/cpp/e2e_compile_determinism_test.cpp`, `scripts/ci/t81lang_repro_gate.py` | 2026-03-06 | In Progress |
| A1-CODE-04 | Expand reproducibility fixture coverage for currently high-drift grammar/semantic cases | `spec/t81lang-spec.md` sections 1, 2, 6 | `tests/fixtures/t81lang_determinism/` | `scripts/ci/t81lang_repro_gate.py` | 2026-03-09 | Planned |
| A1-CODE-05 | Add conformance tests for uncovered match/loop/annotation edge semantics identified by matrix | `spec/t81lang-spec.md` sections 3 and 6 | frontend parser/semantic/IR paths | `tests/cpp/semantic_analyzer_match_test.cpp`, `tests/cpp/semantic_analyzer_loop_test.cpp`, `tests/cpp/e2e_match_expression_test.cpp` | 2026-03-12 | Planned |
