...
| Legacy path scan | `bash scripts/architecture/check_legacy_paths.sh` | FAIL | False positives from records inventories (tracked exception EX-2026-02-01) |
...
1. Resolve EX-2026-02-01 legacy path scan false-positive scope gap.
2. Confirm CI-green and freeze-exception label status at release cut time.
