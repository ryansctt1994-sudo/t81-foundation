...
| `docs/` | Guides, portal narratives, quickstarts, and generated assets (`docs/api`). |
...
- The `docs/api` directory is auto-generated by Doxygen; open `docs/api/html/index.html` locally after running the `docs` target to confirm the manifest matches the implementation.
