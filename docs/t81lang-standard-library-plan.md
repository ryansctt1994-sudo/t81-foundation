...
- `std.collections`: roadmap module entrypoints `list`, `map`, `set`, `tree`, and `graph` are now exposed as deterministic placeholder-handle aliases for staged implementation.
