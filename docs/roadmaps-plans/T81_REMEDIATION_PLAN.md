...
| `VM` | `AxCheck`, `AxReport` | `src/vm/vm.cpp` | **DONE** | Implemented functional logging behavior. |
| `VM` | `AxSign`, `AxCanon`, etc. | `src/vm/vm.cpp` | **Pending** | Currently stubs logging "Cognitive Opcode Stub Execution". |
