...
## 7.1 Metodologia de Verificação Formal
...
## 7.2 A Matriz de Auditoria Formal
...
## 7.3 Testes Baseados em Propriedades
...
## 7.4 O Portão de Determinismo (Determinism Gate)
