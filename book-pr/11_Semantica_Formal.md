# Capítulo 11: Semântica Formal do TISC e T81VM
...
### 11.1.1 A Função de Transição $\delta$
...
## 11.2 Função de Transição Algébrica
...
## 11.3 Sistema de Reescrita de Canonicalização
...
## 11.4 Esboços de Prova de Determinismo
...
## 11.5 Equivalência Intérprete vs Trace-JIT
