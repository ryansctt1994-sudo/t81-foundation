...
➡️ **[T81 Foundation — Определяющая техническая монография](book/book-ru/README.md)**
...
* [1.3 Миссия верифицируемых вычислений](book/book-ru/01_Введение.md#13-миссия-верифицируемых-вычислений)
...
* [2.3 Аудируемость и трассировка Axion](book/book-ru/02_Принципы.md#23-аудируемость-и-трассировка-axion)
* [2.4 Девять принципов (Этический контроль)](book/book-ru/02_Принципы.md#24-девять-принципов-этический-контроль)
...
* [3.1 Формальный конечный автомат](book/book-ru/03_Архитектура.md#31-обзор)
* [3.1.1 Определение состояния](book/book-ru/03_Архитектура.md#31-обзор)
* [3.2 Схема памяти](book/book-ru/03_Архитектура.md#33-модель-памяти)
* [3.3 Регистровый файл](book/book-ru/03_Архитектура.md#33-модель-памяти)
* [3.4 Архитектура набора инструкций TISC (ISA)](book/book-ru/03_Архитектура.md#34-набор-инструкций-tisc)
* [3.5 Семантика сбоев](book/book-ru/03_Архитектура.md#32-граница-рантайма)
* [3.6 Сборка мусора](book/book-ru/03_Архитектура.md#33-модель-памяти)
...
* [5.1 Системные требования](book/book-ru/05_Установка.md#51-требования)
* [5.2 Сборка из исходного кода](book/book-ru/05_Установка.md#52-процедура-сборки)
...
* [6.1 Интерфейс командной строки](book/book-ru/06_Использование.md#61-единый-интерфейс-командной-строки-cli)
* [6.2 Встраивание T81 (C++ API)](book/book-ru/06_Использование.md#61-единый-интерфейс-командной-строки-cli)
* [6.3 Встраивание T81 (Python API)](book/book-ru/06_Использование.md#61-единый-интерфейс-командной-строки-cli)
* [6.4 Отладка](book/book-ru/06_Использование.md#612-отладка-и-инспекция)
...
7. **[Верификация и аудит](book/book-ru/07_Верификация_и_Аудит.md)**
* [7.1 Методология формальной верификации](book/book-ru/07_Верификация_и_Аудит.md#71-стек-верификации)
* [7.2 Формальная матрица аудита](book/book-ru/07_Верификация_и_Аудит.md#71-стек-верификации)
* [7.3 Тестирование на основе свойств](book/book-ru/07_Верификация_и_Аудит.md#71-стек-верификации)
* [7.4 Гейт детерминизма](book/book-ru/07_Верификация_и_Аудит.md#72-гейт-детерминизма)


8. **[Ядро безопасности Axion](book/book-ru/08_Ядро_Axion.md)**
* [8.1 Формальное определение](book/book-ru/08_Ядро_Axion.md#81-формальное-определение)
* [8.2 Модель политик](book/book-ru/08_Ядро_Axion.md#82-модель-политик)
* [8.3 Перехват инструкций](book/book-ru/08_Ядро_Axion.md#83-перехват-инструкций)
* [8.4 Журнал аудита (Трасса)](book/book-ru/08_Ядро_Axion.md#84-журнал-аудита-трасса)
* [8.5 Когнитивное продвижение](book/book-ru/08_Ядро_Axion.md#85-когнитивное-продвижение)


9. **[Когнитивные уровни и распределенные вычисления](book/book-ru/09_Когнитивные_Уровни_и_Распределенные_Вычисления.md)**
* [9.1 Модель когнитивных уровней](book/book-ru/09_Когнитивные_Уровни_и_Распределенные_Вычисления.md#91-модель-когнитивных-уровней)
* [9.2 Распределенные вычисления (Уровень 4)](book/book-ru/09_Когнитивные_Уровни_и_Распределенные_Вычисления.md#92-распределенные-вычисления-уровень-4)
* [9.3 Trace-Based JIT-компиляция](book/book-ru/09_Когнитивные_Уровни_и_Распределенные_Вычисления.md#92-распределенные-вычисления-уровень-4)
* [9.4 Бесконечные формы (Уровень 5)](book/book-ru/09_Когнитивные_Уровни_и_Распределенные_Вычисления.md#93-бесконечные-формы-уровень-5)


10. **[Приложения](book/book-ru/10_Приложения.md)**

* [10.1 Что еще не реализовано](book/book-ru/10_Приложения.md#101-что-еще-не-реализовано)
* [10.2 Модель угроз и поверхность атак на детерминизм](book/book-ru/10_Приложения.md#101-что-еще-не-реализовано)
* [10.3 Глоссарий](book/book-ru/10_Приложения.md#103-полезные-ссылки)
...
11. **[Формальная семантика TISC и T81VM](book/book-ru/11_Формальная_Семантика.md)**

* [Денотационная семантика TISC](book/book-ru/11_Формальная_Семантика.md#111-операционная-семантика)
* [Алгебраическая функция перехода δ](book/book-ru/11_Формальная_Семантика.md#1111-функция-перехода)
* [Система перезаписи канонизации](book/book-ru/11_Формальная_Семантика.md#111-операционная-семантика)
* [Наброски доказательств детерминизма](book/book-ru/11_Формальная_Семантика.md#1111-функция-перехода)
* [Эквивалентность интерпретатора и Trace-JIT](book/book-ru/11_Формальная_Семантика.md#1111-функция-перехода)

12. **[Состязательное моделирование и атаки на детерминизм](book/book-ru/12_Состязательное_Моделирование.md)**

* [Атаки на уровне компилятора](book/book-ru/12_Состязательное_Моделирование.md#121-модель-угроз)
* [Векторы атак на VM и GC](book/book-ru/12_Состязательное_Моделирование.md#121-модель-угроз)
* [Атаки на CanonFS и хэширование](book/book-ru/12_Состязательное_Моделирование.md#121-модель-угроз)
* [Атака «путешествие во времени» в распределенном уровне](book/book-ru/12_Состязательное_Моделирование.md#1212-атаки-с-путешествием-во-времени)
* [Шаблон постмортема нарушения детерминизма](book/book-ru/12_Состязательное_Моделирование.md#121-модель-угроз)
...
13. **[Непрерывность и устойчивость](book/book-ru/13_Непрерывность_и_Устойчивость.md)**

* [Протокол реконструкции в «чистой комнате»](book/book-ru/13_Непрерывность_и_Устойчивость.md#131-протокол-чистой-комнаты)
* [Единые точки отказа](book/book-ru/13_Непрерывность_и_Устойчивость.md#131-протокол-чистой-комнаты)
* [Манифест непрерывности](book/book-ru/13_Непрерывность_и_Устойчивость.md#131-протокол-чистой-комнаты)
* [Неизменяемые формальные инварианты](book/book-ru/13_Непрерывность_и_Устойчивость.md#132-долгосрочное-архивирование)

14. **[Исследовательский фронтир](book/book-ru/14_Исследовательский_Фронтир.md)**

* [Троичное аппаратное ускорение](book/book-ru/14_Исследовательский_Фронтир.md)
* [Пути формальной верификации](book/book-ru/14_Исследовательский_Фронтир.md)
* [CanonFS как субстрат Меркла](book/book-ru/14_Исследовательский_Фронтир.md)
* [Детерминированный инференс ИИ в масштабе](book/book-ru/14_Исследовательский_Фронтир.md)
