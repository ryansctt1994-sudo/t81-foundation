...
T81 — это суверенный вычислительный стек, разработанный для снижения недетерминизма плавающей запятой и обеспечения полностью аудируемого выполнения на верифицированных поверхностях. Используя **сбалансированную троичную логику** и **типы данных с основанием 81**, T81 ориентируется на побитовую воспроизводимость в верифицированных поверхностях, ограниченных реестром детерминизма. Он включает в себя **T81VM**, **движок безопасности Axion** и систему рекурсивных уровней для масштабирования от простой символьной логики до распределенных бесконечных форм.

> 💡 **Почему это важно:** В безопасности ИИ, финансовом моделировании и криптографии "почти правильно" недостаточно. T81 приоритизирует явные детерминированные гарантии на верифицированных поверхностях.
...
| :--- | :--- | :--- |
| **Детерминированное Выполнение** | ✨ Стабильно | Побитово точные результаты на верифицированных поверхностях, ограниченных реестром детерминизма. |
...
| **T81VM и TISC** | 🚧 Beta | Исполнительная поверхность активна и проходит непрерывную верификацию. |
| **Движок Axion** | ⚠️ Alpha | Движок политик активен, но покрытие поверхностей черновой спецификации пока частичное. |
| **Инструменты Моделирования** | ✨ Стабильно | Импорт/Инспекция SafeTensors, GGUF, T81W; поддержка квантования. |
| **Шлюз Воспроизводимости** | ✨ Стабильно | `t81lang_repro_gate.py` в CI выявляет регрессии воспроизводимости на верифицированных поверхностях. |
...
Смотрите `kernel/axion/` для деталей реализации или запускайте примеры `axion_policy_runner`.
