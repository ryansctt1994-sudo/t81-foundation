...
Below is an upgraded `Table of Contents` section for your `book/README.md` that includes **deep links into intra-chapter anchors**.

These assume standard GitHub Markdown auto-generated heading IDs (lowercase, spaces → hyphens, punctuation removed).

If any headings differ slightly in your files, adjust the fragment identifiers accordingly.
...
### Part II — The Deterministic Machine
...
### Part III — Governance and Verification
...
### Part IV — Formalization and Structural Hardening
...
### Part V — Continuity and Research Horizon
