...
➡️ **[T81 基金会 — 技术专题论文](book/book-cn/README.md)**
...
2. **[核心原则与不变性](book/book-cn/02_原则.md)**
* [2.1 确定性不变性](book/book-cn/02_原则.md#21-确定性不变性)
* [2.1.1 确定性表面与攻击向量](book/book-cn/02_原则.md#211-确定性表面与攻击向量)
* [2.2 三进制逻辑 (Base-3)](book/book-cn/02_原则.md#22-三进制逻辑-base-3)
* [2.3 可审计性与 Axion 追踪](book/book-cn/02_原则.md#23-可审计性与-axion-追踪)
* [2.4 九项原则 (伦理强制执行)](book/book-cn/02_原则.md#24-九项原则-伦理强制执行)
...
* [3.1 形式化状态机](book/book-cn/03_架构.md#31-形式化状态机)
* [3.1.1 状态定义](book/book-cn/03_架构.md#311-状态定义)
* [3.2 内存布局](book/book-cn/03_架构.md#32-内存布局)
* [3.3 寄存器堆](book/book-cn/03_架构.md#33-寄存器堆)
* [3.4 TISC 指令集架构 (ISA)](book/book-cn/03_架构.md#34-指令集-tisc)
* [3.5 故障语义](book/book-cn/03_架构.md#35-故障语义)
* [3.6 垃圾回收](book/book-cn/03_架构.md#36-垃圾回收)


4. **[数据类型与规范序列化](book/book-cn/04_数据类型与序列化.md)**
* [4.1 原生类型](book/book-cn/04_数据类型与序列化.md#41-原生类型)
* [4.2 T81Float 与 dmath](book/book-cn/04_数据类型与序列化.md#42-t81float-和-dmath)
* [4.3 张量与规范化布局](book/book-cn/04_数据类型与序列化.md#43-张量与规范布局)
* [4.4 规范序列化规则](book/book-cn/04_数据类型与序列化.md#44-规范序列化规则)


5. **[安装与构建验证](book/book-cn/05_安装.md)**
* [5.1 前置条件](book/book-cn/05_安装.md#51-前置条件)
* [5.2 从源码构建](book/book-cn/05_安装.md#52-构建步骤)
* [5.3 验证构建](book/book-cn/05_安装.md#53-确定性网关)


6. **[CLI 与 API 用法](book/book-cn/06_用法.md)**
* [6.1 命令行界面](book/book-cn/06_用法.md#61-统一-cli)
...
7. **[验证与审计](book/book-cn/07_验证与审计.md)**
* [7.1 形式化验证方法论](book/book-cn/07_验证与审计.md#71-验证栈)
* [7.2 形式化审计矩阵](book/book-cn/07_验证与审计.md#72-确定性网关)
* [7.3 基于属性的测试](book/book-cn/07_验证与审计.md#73-追踪验证)
* [7.4 确定性网关](book/book-cn/07_验证与审计.md#74-确定性网关)


8. **[Axion 安全内核](book/book-cn/08_Axion内核.md)**
* [8.1 形式化定义](book/book-cn/08_Axion内核.md#81-形式化定义)
* [8.2 策略模型](book/book-cn/08_Axion内核.md#82-策略模型)
* [8.3 指令拦截](book/book-cn/08_Axion内核.md#83-指令拦截)
* [8.4 审计日志 (追踪)](book/book-cn/08_Axion内核.md#84-审计日志-追踪)
* [8.5 认知提升](book/book-cn/08_Axion内核.md#85-认知提升)


9. **[认知层与分布式计算](book/book-cn/09_认知层与分布式计算.md)**
* [9.1 认知层模型](book/book-cn/09_认知层与分布式计算.md#91-认知层模型)
* [9.2 分布式计算 (第 4 层)](book/book-cn/09_认知层与分布式计算.md#92-分布式计算-第-4-层)
* [9.3 无限形式 (第 5 层)](book/book-cn/09_认知层与分布式计算.md#93-无限形式-第-5-层)
* [9.4 验证清单](book/book-cn/09_认知层与分布式计算.md#94-验证清单)


10. **[附录](book/book-cn/10_附录.md)**
* [10.1 尚未实现的功能](book/book-cn/10_附录.md#101-尚未实现的功能)
* [10.2 错误代码](book/book-cn/10_附录.md#102-错误代码)
* [10.3 有用链接](book/book-cn/10_附录.md#103-有用链接)
...
11. **[TISC 与 T81VM 的形式化语义](book/book-cn/11_形式化语义.md)**
* [TISC 的指称语义](book/book-cn/11_形式化语义.md#111-操作语义)
* [代数转换函数 δ](book/book-cn/11_形式化语义.md#1111-转换函数)
* [规范化重写系统](book/book-cn/11_形式化语义.md#112-内存语义)
* [确定性证明草图](book/book-cn/11_形式化语义.md#112-内存语义)
* [解释器与 Trace-JIT 的等效性](book/book-cn/11_形式化语义.md#1111-转换函数)


12. **[对抗建模与确定性攻击](book/book-cn/12_对抗建模.md)**
* [编译器级攻击](book/book-cn/12_对抗建模.md#121-威胁模型)
* [VM 与 GC 攻击向量](book/book-cn/12_对抗建模.md#1211-libm-gap-向量)
* [CanonFS 与哈希攻击](book/book-cn/12_对抗建模.md#1212-时间旅行攻击)
* [分布式层级时间旅行攻击](book/book-cn/12_对抗建模.md#1212-时间旅行攻击)
* [确定性破坏事后剖析模板](book/book-cn/12_对抗建模.md#122-侧信道弹性)
...
13. **[持续性与韧性](book/book-cn/13_持续性与韧性.md)**
* [无尘室重建协议](book/book-cn/13_持续性与韧性.md#131-无尘室协议)
* [单点故障](book/book-cn/13_持续性与韧性.md#1311-最小引导)
* [持续性宣言](book/book-cn/13_持续性与韧性.md#1312-验证)
* [不可变形式化不变性](book/book-cn/13_持续性与韧性.md#132-长期归档)


14. **[研究前沿](book/book-cn/14_研究前沿.md)**
* [版本历史](book/book-cn/14_研究前沿.md)
