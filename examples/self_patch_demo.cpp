...
int main() {
    ...
    std::vector<Insn> insns = {
        ...
        /*  3 */ {Opcode::Nop}, {Opcode::Nop}, {Opcode::Nop}, {Opcode::Nop},
        /*  7 */ {Opcode::Nop}, {Opcode::Nop}, {Opcode::Nop},
        ...
        /* 14 */ {Opcode::Nop}, {Opcode::Nop}, {Opcode::Nop}, {Opcode::Nop},
        /* 18 */ {Opcode::Nop}, {Opcode::Nop},

        /* 20: Success Exit */
        /* 20 */ {Opcode::Halt},
        /* 21 */ {Opcode::Nop}, {Opcode::Nop}, {Opcode::Nop}, {Opcode::Nop},
        /* 25 */ {Opcode::Nop}, {Opcode::Nop}, {Opcode::Nop}, {Opcode::Nop},
        /* 29 */ {Opcode::Nop},
        ...
        /* 33 */ {Opcode::MetaRead, 12, static_cast<int64_t>(MemorySegmentKind::Code), 11}, // R12 = Read Opcode
        /* 34 */ {Opcode::LoadImm, 13, static_cast<int64_t>(Opcode::Mul)}, // R13 = Target Opcode (Mul)
        /* 35 */ {Opcode::MetaRefine, 14, 12, 13},      // R14 = Refined patch
        /* 36 */ {Opcode::MetaWrite, 13, static_cast<int64_t>(MemorySegmentKind::Code), 11}, // COMMIT PATCH
    ...
    std::cout << "  Failure detected: PC=" << vm->state().pc << " R0=" << vm->state().registers[0] << " (Expected 100)" << std::endl;
