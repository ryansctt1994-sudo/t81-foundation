...
int main() {
  ...
  create_dummy_t3k(weight_names[1],
                   {static_cast<uint64_t>(hidden_dim), static_cast<uint64_t>(hidden_dim)});
  create_dummy_t3k(weight_names[2],
                   {static_cast<uint64_t>(hidden_dim), static_cast<uint64_t>(hidden_dim)});
  create_dummy_t3k(weight_names[3],
                   {static_cast<uint64_t>(hidden_dim), static_cast<uint64_t>(hidden_dim)});
  create_dummy_t3k(weight_names[4],
                   {static_cast<uint64_t>(hidden_dim), static_cast<uint64_t>(hidden_dim)});
  create_dummy_t3k(weight_names[5], {static_cast<uint64_t>(hidden_dim)});
  create_dummy_t3k(weight_names[6],
                   {static_cast<uint64_t>(hidden_dim), static_cast<uint64_t>(hidden_dim)});
  create_dummy_t3k(weight_names[7],
                   {static_cast<uint64_t>(hidden_dim), static_cast<uint64_t>(hidden_dim)});
  create_dummy_t3k(weight_names[8],
                   {static_cast<uint64_t>(hidden_dim), static_cast<uint64_t>(hidden_dim)});
  ...
  if (vm->state().register_tags[reg_x] == vm::ValueTag::TensorHandle) {
    ...
    std::cout << "First 3 elements: " << out_t.data()[0] << ", " << out_t.data()[1] << ", "
              << out_t.data()[2] << "\n";
