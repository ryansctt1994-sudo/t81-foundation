...
- added deterministic Llama-3.2-1B block demo (`examples/llama32_demo.cpp`) demonstrating bit-identical inference across different hardware platforms using ternary-native kernels.
